...
{
    public class ShowReportsMenuCommand : ICommand<ShowReportsMenuCommand>
    {
        private readonly IApplicationController _applicationController;

        public ShowReportsMenuCommand(IApplicationController applicationController)
        {
            _applicationController = applicationController;
        }

        public void Execute(ShowReportsMenuCommand commandData)
        {
